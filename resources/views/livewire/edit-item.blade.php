<div>
    <x-panel class="md:w-1/4 w-full md:min-w-min mt-20 text-center p-4">
        ...
        <form wire:submit.prevent="update">
            <input type="text" wire:model="heading" class="w-full outline-gray-200 shadow-inner rounded my-2 w-full md:w-auto" placeholder="Name and/or Title">
            @error('heading') <span class="error text-xs text-red-600">{{ $message }}</span> @enderror

            <textarea type="textarea" wire:model="description" class="w-full h-40 outline-gray-200 shadow-inner rounded my-2 w-full md:w-auto" placeholder="Description"></textarea>
