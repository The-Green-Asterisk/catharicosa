    ...
    <form wire:submit.prevent="submit">
        <div class="lg:mx-10 2xl:mx-32 md:mx-32 mx-10 my-10 transition-all duration-500" x-show="open">
            <div class="flex items-start">
                <input type="text" wire:model="title" class="shadow-inner grow outline-gray-200 w-full font-bold rounded" value="Notes for {{ now()->tz(auth()->user()->timezone)->toDayDateTimeString() }}" />
                <select name='notebook_id' id="notebook_id" class="outline-gray-200 bg-white px-2 shadow-inner rounded w-full md:w-auto">
